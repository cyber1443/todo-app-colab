 ...
 *
 * Everything lives inside an IIFE because index.html loads this file as a
 * classic <script>, which shares one global scope with the other scripts on
 * the page. A top-level declaration here would collide with an identically
 * named one in web-contract.js and kill whichever script loads second.
 *
